...
enum InfillPattern : int {
    ...
    ipGyroid, ipHilbertCurve, ipArchimedeanChords, ipOctagramSpiral, ipAdaptiveCubic, ipSupportCubic, ipSupportBase, ipLargix, ipCount,
};
...
//  ((ConfigOptionFloat,               seam_preferred_direction_jitter))
    ...
    ((ConfigOptionBool,                largix_spline_interpolation_flag))
    ((ConfigOptionBool,                largix_next_point_flag))
    ((ConfigOptionFloat,               largix_next_point_length))
    ...
    ((ConfigOptionFloat,               largix_retraction_return_length))
